...
class sensorADC:
    ...
    def __process__(self):
        ...
        self.fileWriteHeader += currentData['timecapture']['660nmch1'] +','+ str(currentData['values']['660nmch1']) +','+ str(currentData['voltages']['660nmch1']) +','+ currentData['timecapture']['870nmch1'] +','+ str(currentData['values']['870nmch1']) +','+ str(currentData['voltages']['870nmch1']) +','+ currentData['timecapture']['1200nmch1'] +','+ str(currentData['values']['1200nmch1']) +','+ str(currentData['voltages']['1200nmch1']) +','+ currentData['timecapture']['1550nmch1'] +','+ str(currentData['values']['1550nmch1']) +','+ str(currentData['voltages']['1550nmch1']) +','+ currentData['timecapture']['660nmch2'] +','+ str(currentData['values']['660nmch2']) +','+ str(currentData['voltages']['660nmch2']) +','+ currentData['timecapture']['870nmch2'] +','+ str(currentData['values']['870nmch2']) +','+ str(currentData['voltages']['870nmch2']) +','+ currentData['timecapture']['1200nmch2'] +','+ str(currentData['values']['1200nmch2']) +','+ str(currentData['voltages']['1200nmch2']) +','+ currentData['timecapture']['1550nmch2'] +','+ str(currentData['values']['1550nmch2']) +','+ str(currentData['voltages']['1550nmch2']) +','+ currentData['timecapture']['660nmch3'] +','+ str(currentData['values']['660nmch3']) +','+ str(currentData['voltages']['660nmch3']) +','+ currentData['timecapture']['870nmch3'] +','+ str(currentData['values']['870nmch3']) +','+ str(currentData['voltages']['870nmch3']) +','+ currentData['timecapture']['1200nmch3'] +','+ str(currentData['values']['1200nmch3']) +','+ str(currentData['voltages']['1200nmch3']) +','+ currentData['timecapture']['1550nmch3'] +','+ str(currentData['values']['1550nmch3']) +','+ str(currentData['voltages']['1550nmch3']) +','+ currentData['timecapture']['660nmch4'] +','+ str(currentData['values']['660nmch4']) +','+ str(currentData['voltages']['660nmch4']) +','+ currentData['timecapture']['870nmch4'] +','+ str(currentData['values']['870nmch4']) +','+ str(currentData['voltages']['870nmch4']) +','+ currentData['timecapture']['1200nmch4'] +','+ str(currentData['values']['1200nmch4']) +','+ str(currentData['voltages']['1200nmch4']) +','+ currentData['timecapture']['1550nmch4'] +','+ str(currentData['values']['1550nmch4']) +','+ str(currentData['voltages']['1550nmch4']) +'\n'

        with open('/home/aeelab/fnirsLogSheet.csv', 'w') as file1:
